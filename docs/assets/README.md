...
| Versão | Screenshots | Vídeos | Apresentações | Tag Git | GitHub Release |
|--------|-------------|--------|---------------|---------|----------------|
| **v0.4.0** | [`screenshots/v0.4.0/`](screenshots/v0.4.0/) · 51 capturas | [`videos/v0.4.0/`](videos/v0.4.0/) · 1 tour | [`presentations/v0.4.0/`](presentations/v0.4.0/) | ✅ `v0.4.0` | ✅ [Publicada](https://github.com/Lucash67/terus-platform/releases/tag/v0.4.0) |
