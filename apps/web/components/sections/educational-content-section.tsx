...
import { CONTEUDOS_EDUCACIONAIS } from "@/lib/constants/site-data";
      ...
      <Container className="py-20 sm:py-24">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-display text-heading-xl font-bold text-text-primary sm:text-display-lg">
            Aprenda sobre operação e execução
          </h2>
          <p className="mt-4 text-body-lg text-text-secondary">
            Estrutura preparada para exibir vídeos e materiais educacionais
            relacionados à jornada operacional.
          </p>
        </div>

        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {CONTEUDOS_EDUCACIONAIS.map((content) => (
            <div
              key={content.title}
